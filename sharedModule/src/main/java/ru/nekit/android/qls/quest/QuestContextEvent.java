...
public class QuestContextEvent {

    public static final String EVENT_TIC_TAC = "eventTicTac";
    public static final String EVENT_LEVEL_UP = "eventLevelUp";
    ...
    public static final String EVENT_QUEST_CREATE = "eventQuestCreate";
