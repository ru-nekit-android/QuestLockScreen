...
import ru.nekit.android.qls.quest.view.mediator.content.AbstractQuestContentMediator;
            ...
            case UNKNOWN_MEMBER:
                ...
                if (quest.leftNode != null) {
                    for (int i = quest.leftNode.length - 1; i >= 0; i--) {
                        ...
                        CoinVisualResourceCollection coinVisualResourceCollection = CoinVisualResourceCollection.getById(quest.leftNode[i]);
                        if (coinVisualResourceCollection != null) {
                            CoinViewHolder coinViewHolder = CoinViewBuilder.createView(questContext,
                                    coinVisualResourceCollection);
