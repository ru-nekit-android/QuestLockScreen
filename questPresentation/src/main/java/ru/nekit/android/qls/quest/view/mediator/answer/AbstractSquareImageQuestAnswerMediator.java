...
import ru.nekit.android.qls.quest.view.mediator.adapter.SquareImageAdapter;

public abstract class AbstractSquareImageQuestAnswerMediator
        extends AbstractListableQuestAnswerMediator<Integer, SquareImageAdapter> {
