...
import static ru.nekit.android.qls.quest.resources.collections.VisualResourceGroupCollection.FRUIT;
...
public class FruitArithmeticQuestTrainingProgramRule extends AbstractQuestTrainingProgramRule {
    ...
    public Quest makeQuest(@NonNull final QuestContext questContext,
        ...
        if (questionType == QuestionType.SOLUTION) {
            ...
            List<IVisualResourceHolder> visualResourceItemList =
            ...
            generator.setAvailableMemberValues(visualResourceItemList.subList(0, answerVariants),
                    new Callable<IVisualResourceHolder, Integer>() {
                        @Override
                        public Integer call(IVisualResourceHolder value) {
