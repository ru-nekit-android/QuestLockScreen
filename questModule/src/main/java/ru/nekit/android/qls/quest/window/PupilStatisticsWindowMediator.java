...
public class PupilStatisticsWindowMediator extends WindowMediator implements View.OnClickListener,
        ...
        if (mCurrentStep != step) {
            ...
            switch (step) {
                ...
                case CONTENT:
                    ...
                    mCurrentContentHolder = new PupilStatisticsContentViewHolder(mQuestContext);
                    PupilStatisticsContentViewHolder contentViewHolder =
                            (PupilStatisticsContentViewHolder) mCurrentContentHolder;
    ...
    public void onEvent(@NonNull Intent intent) {
        ...
        if (action != null) {
            switch (action) {
                ...
                case Window.EVENT_WINDOW_OPENED:
