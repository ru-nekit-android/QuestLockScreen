...
public class TransitionChoreograph {
    ...
    TransitionChoreograph(@NonNull QuestContext context) {
        mQuestContext = context;
        mQuestSeriesCounter = new CountdownCounter(context, QUEST_SERIES_COUNTDOWN_NAME,
                mQuestContext.getQuestSeriesLength());
        mAdvertCounter = new CountdownCounter(context, ADVERT_COUNTDOWN_NAME,
