...
public class LockScreenService extends Service implements MessageGateway.MessageListener,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        boolean setupWizardIsComplete = getQuestSetupWizard().setupIsComplete();
    ...
    private QuestSetupWizard getQuestSetupWizard() {
        return QuestSetupWizard.getInstance(getApplicationContext());
    }
